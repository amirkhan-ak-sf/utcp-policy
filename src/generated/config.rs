...
pub struct Config {
    ...
    pub egress_base_url: pdk::hl::Service,
    ...
    #[serde(alias = "outboundTimeoutMs")]
    pub outbound_timeout_ms: Option<i64>,
...
fn init(abi: &dyn pdk::flex_abi::api::FlexAbi) -> Result<(), anyhow::Error> {
    ...
    abi.service_create(config.egress_base_url)?;
    abi.setup()?;
    Ok(())
}
